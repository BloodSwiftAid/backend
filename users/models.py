...
class BaseOrganization(BaseModel):
    ...
    state = models.CharField(max_length=100, blank=True, null=False, default='Not Provided')
    city = models.CharField(max_length=100, blank=True, null=True)
    area = models.CharField(max_length=100, blank=True, null=False, default='Not Provided')
...
class BloodBank(BaseOrganization):
    license_number = models.CharField(max_length=100, blank=True, null=False, default='Not Provided')
